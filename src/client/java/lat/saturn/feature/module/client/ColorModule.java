...
public class ColorModule extends Module {
    ...
    public ColorSetting clientColor = new ColorSetting("Accent Color", "Color used when syncing other color settings", new Color(163, 97, 150), true, false, false, false);
