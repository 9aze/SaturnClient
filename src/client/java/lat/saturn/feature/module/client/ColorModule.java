...
@RegisterModule(name="Color", description = "The client's color settings.", category = Category.MISC, toggled = true, alwaysActive = true)
public class ColorModule extends Module {
    public static ColorModule INSTANCE = null;
    public ColorSetting clientColor = new ColorSetting("Accent Color", "Color used when syncing other color settings", new Color(0, 0, 0), true, false, false, false);
